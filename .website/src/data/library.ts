...
export const librarySections: LibrarySection[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      ...eieCoursePages,
      { id: 'c-language', title: 'C 语言程序设计', summary: '考试范围、题库、历年试卷与习题解答。', content: cLanguage, legacyPath: 'docs/c-language.md', keywords: ['C语言', '程序设计', '公共C题库'] },
      { id: 'engineering-drawing', title: '工程制图 B', summary: '复习资料、历年试卷与习题解答。', content: engineeringDrawing, legacyPath: 'docs/engineering-drawing.md', keywords: ['工程制图', '机械制图', '工图'] },
      { id: 'microcomputer', title: '微机原理', summary: '复习资料、历年试卷、实验、教材与习题解答。', content: microcomputer, legacyPath: 'docs/microcomputer.md', keywords: ['微机原理与接口技术', '8086', '汇编'] },
      { id: 'control-engineering', title: '控制工程', summary: '自动控制原理试卷、题库与习题解答。', content: controlEngineering, legacyPath: 'docs/control-engineering.md', keywords: ['自动控制原理', '自控'] },
      { id: 'complex-functions', title: '复变函数与积分变换', summary: '2009-2025 年试卷、复习资料、题库与习题解答。', content: complexFunctions, legacyPath: 'docs/complex-functions.md', keywords: ['复变函数', '积分变换'] },
      { id: 'digital-electronics', title: '数字电子技术', summary: '复习资料、题库、历年试卷与习题解答。', content: digitalElectronics, legacyPath: 'docs/digital-electronics.md', keywords: ['数电', '数字电路'] },
      { id: 'analog-electronics', title: '模拟电子技术', summary: '复习、题库、试卷、仿真文件与习题答案。', content: analogElectronics, legacyPath: 'docs/analog-electronics.md', keywords: ['模电', '模拟电路', 'Multisim'] },
      { id: 'circuit', title: '电路', summary: '复习资料、历年试卷与习题解答。', content: circuit, legacyPath: 'docs/circuit.md', keywords: ['电路原理'] },
      { id: 'college-english', title: '大学英语', summary: '期末考试题型、复习资料、课文翻译与习题答案。', content: collegeEnglish, legacyPath: 'docs/college-english.md', keywords: ['新视野大学英语', '读写', '视听说'] },
      { id: 'college-chinese', title: '大学语文', summary: '课程题库与阅读资料。', content: collegeChinese, legacyPath: 'docs/college-chinese.md' },
      ...
      { id: 'marxist-principles', title: '马克思主义基本原理', summary: '复习资料与历年试卷。', content: marxistPrinciples, legacyPath: 'docs/marxist-principles.md', keywords: ['马原', '马克思主义基本原理概论'] },
